...
abstract final class ColorsManager {
  ColorsManager._();
  //
  static const primary = Color(0xff2A4BA0);
  static const primaryDark = Color(0xff153075);
  static const secondary = Color(0xffF9B023);
  static const secondaryLight = Color(0xffFFC83A);
  //
